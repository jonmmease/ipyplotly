import pytest
from ipyplotly.basevalidators import ColorscaleValidator
import numpy as np
...
def test_coercion_named(named_colorscale, validator: ColorscaleValidator):
    ...
    # Uppercase
    assert validator.validate_coerce(named_colorscale.upper()) == named_colorscale

    # Lowercase
    assert validator.validate_coerce(named_colorscale.lower()) == named_colorscale
